...
import me from "../assets/images/about/profile.png";
        ...
        <React.Fragment>
            <div className="aboutContainer">
                <div align="center" className="upperNameHeading nameHeading">
                    <span ref={upperNameHeadingRef}>Hey, I'm Hema Sree.</span>
                </div>
                <div className="row">
                    ...
                    <div className="col-md-7 col-sm-8 col">
                        ...
                        >
                            I am a graduate Information Systems student at Northeastern University. I am actively looking for full time SDE roles starting May, 2024.
                            I have 4 years of work experience as a software developer. I love to solve new challenges everyday.
                        </p>
                        <span>
